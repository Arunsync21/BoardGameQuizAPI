        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificates_Sets_SetId",
                        column: x => x.SetId,
                        principalTable: "Sets",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProgresses_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "SectionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProgresses_Sets_SetId",
                        column: x => x.SetId,
                        principalTable: "Sets",
                        principalColumn: "SetId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserResponses_Options_OptionId",
                        column: x => x.OptionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProgresses_SectionId",
                table: "UserProgresses",
                column: "SectionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProgresses_SetId",
                table: "UserProgresses",
                column: "SetId");
